 ...
 */
replete.editor.cmirror_eval_box = (function replete$editor$cmirror_eval_box(p__3789){
...
var opts = cljs.core.get.call(null,map__3790__$1,new cljs.core.Keyword(null,"opts","opts",155075701));
var cm_opts = cljs.core.get.call(null,map__3790__$1,new cljs.core.Keyword(null,"cm-opts","cm-opts",-794223420));
var style = cljs.core.get.call(null,map__3790__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
return ((function (result,map__3790,map__3790__$1,opts,cm_opts,style){
return (function (){
...
;})(result,map__3790,map__3790__$1,opts,cm_opts,style))
});
/**
...
replete.editor.edit_box = (function replete$editor$edit_box(p__3792){
var map__3793 = p__3792;
...
var opts = cljs.core.get.call(null,map__3793__$1,new cljs.core.Keyword(null,"opts","opts",155075701));
var cm_opts = cljs.core.get.call(null,map__3793__$1,new cljs.core.Keyword(null,"cm-opts","cm-opts",-794223420));
var key_bindings = cljs.core.get.call(null,map__3793__$1,new cljs.core.Keyword(null,"key-bindings","key-bindings",-1464217982));
var style = cljs.core.get.call(null,map__3793__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.v_box,new cljs.core.Keyword(null,"size","size",1098693007),"100%",new cljs.core.Keyword(null,"gap","gap",80255254),"5px",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [replete.editor.cmirror_edit_box,ed_opts,cmirror_opts,style], null),new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.button,new cljs.core.Keyword(null,"class","class",-2030961996),"btn-primary",new cljs.core.Keyword(null,"label","label",1718410804),"XYo",new cljs.core.Keyword(null,"tooltip","tooltip",-1809677058),["Shortcut: ",(function (){var G__3796 = new cljs.core.Keyword(null,"enter","enter",1792452624).cljs$core$IFn$_invoke$arity$1(key_bindings);
if((G__3796 == null)){
return null;
} else {
return cljs.core.name.call(null,G__3796);
}
})()].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (ed_opts,cmirror_opts,map__3793,map__3793__$1,opts,cm_opts,key_bindings,style){
return (function (){
...
});})(ed_opts,cmirror_opts,map__3793,map__3793__$1,opts,cm_opts,key_bindings,style))
], null)], null)], null);
});
...
replete.editor.key_binding = (function replete$editor$key_binding(key_map,p__3797){
var vec__3798 = p__3797;
var button = cljs.core.nth.call(null,vec__3798,(0),null);
var event = cljs.core.nth.call(null,vec__3798,(1),null);
return cljs.core.assoc.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.get.call(null,key_map,button),((function (vec__3798,button,event){
return (function (){
