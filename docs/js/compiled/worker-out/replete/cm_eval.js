...
replete.cm_eval.dim_text = (function replete$cm_eval$dim_text(cm,p__2054){
var map__2055 = p__2054;
var map__2055__$1 = (((((!((map__2055 == null))))?(((((map__2055.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2055.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2055):map__2055);
var start = cljs.core.get.call(null,map__2055__$1,new cljs.core.Keyword(null,"start","start",-355208981));
var end = cljs.core.get.call(null,map__2055__$1,new cljs.core.Keyword(null,"end","end",-268185958));
var width = cljs.core.get.call(null,map__2055__$1,new cljs.core.Keyword(null,"width","width",-384071477));
...
var map__2057 = replete.cm_eval.parse_prepl_response.call(null,prepl_response);
var map__2057__$1 = (((((!((map__2057 == null))))?(((((map__2057.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2057.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2057):map__2057);
var form = cljs.core.get.call(null,map__2057__$1,new cljs.core.Keyword(null,"form","form",-1624062471));
var form_gap = cljs.core.get.call(null,map__2057__$1,new cljs.core.Keyword(null,"form-gap","form-gap",514237880));
var output = cljs.core.get.call(null,map__2057__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var result_gap = cljs.core.get.call(null,map__2057__$1,new cljs.core.Keyword(null,"result-gap","result-gap",1343464295));
...
var map__2059 = opts;
var map__2059__$1 = (((((!((map__2059 == null))))?(((((map__2059.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2059.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2059):map__2059);
var node_id = cljs.core.get.call(null,map__2059__$1,new cljs.core.Keyword(null,"node-id","node-id",779482292));
var preamble_markup = cljs.core.get.call(null,map__2059__$1,new cljs.core.Keyword(null,"preamble-markup","preamble-markup",1557120511));
var preamble_text = cljs.core.get.call(null,map__2059__$1,new cljs.core.Keyword(null,"preamble-text","preamble-text",-1480702866));
var cm_options = cljs.core.get.call(null,map__2059__$1,new cljs.core.Keyword(null,"cm-options","cm-options",-1418884096));
var cm_update = cljs.core.partial.call(null,replete.cm_eval.update_component,cmirror,mark_up,preamble_markup);
return reagent.core.create_class.call(null,new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"reagent-render","reagent-render",-985383853),((function (cmirror,mark_up,map__2059,map__2059__$1,node_id,preamble_markup,preamble_text,cm_options,cm_update){
...
});})(cmirror,mark_up,map__2059,map__2059__$1,node_id,preamble_markup,preamble_text,cm_options,cm_update))
,new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),((function (cmirror,mark_up,map__2059,map__2059__$1,node_id,preamble_markup,preamble_text,cm_options,cm_update){
return (function replete$cm_eval$cmirror_eval_comp_$_cm_did_mount(compnt){
var node_2061 = reagent.dom.dom_node.call(null,compnt);
var cm_2062 = replete.cm.cm_parinfer.call(null,node_2061,cm_options);
cm_2062.setValue(preamble_text);

replete.cm_eval.dim_text.call(null,cm_2062,preamble_markup);

cljs.core.reset_BANG_.call(null,cmirror,cm_2062);

re_frame.core.dispatch.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("replete.events","eval-codemirror","replete.events/eval-codemirror",1530280838),cm_2062], null));

return cm_update.call(null,compnt);
});})(cmirror,mark_up,map__2059,map__2059__$1,node_id,preamble_markup,preamble_text,cm_options,cm_update))
,new cljs.core.Keyword(null,"component-will-unmount","component-will-unmount",-2058314698),((function (cmirror,mark_up,map__2059,map__2059__$1,node_id,preamble_markup,preamble_text,cm_options,cm_update){
