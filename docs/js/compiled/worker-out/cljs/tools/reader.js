...
var G__3025 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__3025;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__3026 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__3026,ch);
...
if(("\\" === ch__$1)){
var ch_3027__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_3027__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_3027__$2);
} else {
}

var G__3028 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__3028;
continue;
}
}
...
var vec__3036 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__3036,(0),null);
var start_column = cljs.core.nth.call(null,vec__3036,(1),null);
...
var G__3039 = cljs.core.conj_BANG_.call(null,a,form);
a = G__3039;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__3040 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__3041 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__3041;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__3040;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__3042 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__3042,(0),null);
var start_column = cljs.core.nth.call(null,vec__3042,(1),null);
...
var vec__3045 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__3045,(0),null);
var end_column = cljs.core.nth.call(null,vec__3045,(1),null);
...
var vec__3048 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__3048,(0),null);
var start_column = cljs.core.nth.call(null,vec__3048,(1),null);
...
var vec__3051 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__3051,(0),null);
var end_column = cljs.core.nth.call(null,vec__3051,(1),null);
...
var vec__3054 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__3054,(0),null);
var start_column = cljs.core.nth.call(null,vec__3054,(1),null);
...
var vec__3057 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__3057,(0),null);
var end_column = cljs.core.nth.call(null,vec__3057,(1),null);
...
var sb = (function (){var G__3060 = (new goog.string.StringBuffer());
G__3060.append(initch);
...
var G__3062 = (function (){var G__3061 = sb;
G__3061.append(ch);

return G__3061;
})();
var G__3063 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__3062;
ch = G__3063;
continue;
}
...
switch (G__3066) {
case "\\":
var G__3070 = (function (){var G__3067 = sb;
G__3067.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__3067;
})();
var G__3071 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__3070;
ch = G__3071;
continue;
...
break;
default:
var G__3072 = (function (){var G__3068 = sb;
G__3068.append(ch);

return G__3068;
})();
var G__3073 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__3072;
ch = G__3073;
continue;
...
var vec__3074 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__3074,(0),null);
var end_column = cljs.core.nth.call(null,vec__3074,(1),null);
...
var vec__3077 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__3077,(0),null);
var column = cljs.core.nth.call(null,vec__3077,(1),null);
...
var vec__3082 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__3082,(0),null);
var column = cljs.core.nth.call(null,vec__3082,(1),null);
...
var vec__3087 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__3087,(0),null);
var column = cljs.core.nth.call(null,vec__3087,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__3092 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__3092,(0),null);
var start_column = cljs.core.nth.call(null,vec__3092,(1),null);
...
var vec__3095 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__3095,(0),null);
var end_column = cljs.core.nth.call(null,vec__3095,(1),null);
...
var G__3098 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__3098,true,null,opts,pending_forms);
...
var G__3099 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__3099)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__3099)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__3099)){
...
var _STAR_suppress_read_STAR__orig_val__3100 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__3101 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__3101;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__3100;
}});
...
var G__3102 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__3102,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__3102,rdr,first_line);
...
var G__3106 = matched;
var G__3107 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__3106;
finished = G__3107;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__3108 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__3109 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__3109;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__3108;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__3110 = cljs.tools.reader.arg_env;
var arg_env_temp_val__3111 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__3111;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__3112 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__3112,"(");
...
var G__3113 = (i + (1));
var G__3114 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__3110;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__3115 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__3115);
...
var G__3118 = cljs.core.next.call(null,s);
var G__3119 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__3118;
key_vals = G__3119;
continue;
} else {
...
var gensym_env_orig_val__3123 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__3124 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__3124;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__3123;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__3125 = token;
var G__3125__$1 = (((G__3125 == null))?null:cljs.core.subs.call(null,G__3125,(1)));
var G__3125__$2 = (((G__3125__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__3125__$1));
var G__3125__$3 = (((G__3125__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__3125__$2));
var G__3125__$4 = (((G__3125__$3 == null))?null:cljs.core.symbol.call(null,G__3125__$3));
if((G__3125__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__3125__$4);
}
})():(function (){var G__3126 = token;
var G__3126__$1 = (((G__3126 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__3126));
if((G__3126__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__3126__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
}catch (e3133){if((e3133 instanceof Error)){
var e = e3133;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__3137,reader){
...
var opts = map__3138__$1;
var eof = cljs.core.get.call(null,map__3138__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4730__auto___3146 = arguments.length;
var i__4731__auto___3147 = (0);
while(true){
if((i__4731__auto___3147 < len__4730__auto___3146)){
args__4736__auto__.push((arguments[i__4731__auto___3147]));

var G__3148 = (i__4731__auto___3147 + (1));
i__4731__auto___3147 = G__3148;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq3144){
var G__3145 = cljs.core.first.call(null,seq3144);
var seq3144__$1 = cljs.core.next.call(null,seq3144);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__3145,seq3144__$1);
});
