...
var G__1041 = o;
(G__1041[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__1042__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__1042 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__1043__i = 0, G__1043__a = new Array(arguments.length -  0);
while (G__1043__i < G__1043__a.length) {G__1043__a[G__1043__i] = arguments[G__1043__i + 0]; ++G__1043__i;}
  args = new cljs.core.IndexedSeq(G__1043__a,0,null);
} 
return G__1042__delegate.call(this,args);};
G__1042.cljs$lang$maxFixedArity = 0;
G__1042.cljs$lang$applyTo = (function (arglist__1044){
var args = cljs.core.seq(arglist__1044);
return G__1042__delegate(args);
});
G__1042.cljs$core$IFn$_invoke$arity$variadic = G__1042__delegate;
return G__1042;
})()
;
} else {
...
var G__1045 = o;
(G__1045[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__1046__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__1046 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__1047__i = 0, G__1047__a = new Array(arguments.length -  0);
while (G__1047__i < G__1047__a.length) {G__1047__a[G__1047__i] = arguments[G__1047__i + 0]; ++G__1047__i;}
  args = new cljs.core.IndexedSeq(G__1047__a,0,null);
} 
return G__1046__delegate.call(this,args);};
G__1046.cljs$lang$maxFixedArity = 0;
G__1046.cljs$lang$applyTo = (function (arglist__1048){
var args = cljs.core.seq(arglist__1048);
return G__1046__delegate(args);
});
G__1046.cljs$core$IFn$_invoke$arity$variadic = G__1046__delegate;
return G__1046;
})()
;
} else {
...
var G__1050 = props;
var G__1050__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__1050,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__1050);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__1050__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__1051){
var map__1052 = p__1051;
var map__1052__$1 = (((((!((map__1052 == null))))?(((((map__1052.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1052.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1052):map__1052);
var props = map__1052__$1;
var class$ = cljs.core.get.call(null,map__1052__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__1052,map__1052__$1,props,class$){
return (function (c){
...
});})(map__1052,map__1052__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__1054){
var map__1055 = p__1054;
...
var on_write = cljs.core.get.call(null,map__1055__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__1055,map__1055__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__1055,map__1055__$1,on_write))
);
} else {
...
var G__1058 = jsprops;
(G__1058["defaultValue"] = value);

(G__1058["onChange"] = ((function (G__1058,v,value,on_change){
return (function (p1__1057_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__1057_SHARP_);
});})(G__1058,v,value,on_change))
);
...
var vec__1061 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__1061,(0),null);
var id = cljs.core.nth.call(null,vec__1061,(1),null);
var class$ = cljs.core.nth.call(null,vec__1061,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___1065 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___1065 == null)){
} else {
var key_1066 = temp__5724__auto___1065;
(jsprops["key"] = key_1066);
}
...
var temp__5724__auto___1067 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___1067 == null)){
} else {
var key_1068 = temp__5724__auto___1067;
reagent.impl.template.oset.call(null,jsprops,"key",key_1068);
}
...
var G__1069 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__1069["name"] = c);
...
var len__4730__auto___1075 = arguments.length;
var i__4731__auto___1076 = (0);
while(true){
if((i__4731__auto___1076 < len__4730__auto___1075)){
args__4736__auto__.push((arguments[i__4731__auto___1076]));

var G__1077 = (i__4731__auto___1076 + (1));
i__4731__auto___1076 = G__1077;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq1073){
var G__1074 = cljs.core.first.call(null,seq1073);
var seq1073__$1 = cljs.core.next.call(null,seq1073);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__1074,seq1073__$1);
});
...
break;
default:
var G__1080 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__1080;
continue;
...
var n__4607__auto___1082 = a.length;
var i_1083 = (0);
while(true){
if((i_1083 < n__4607__auto___1082)){
(a[i_1083] = reagent.impl.template.as_element.call(null,(a[i_1083])));
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___1085 = a.length;
var i_1086 = (0);
while(true){
if((i_1086 < n__4607__auto___1085)){
var val_1087 = (a[i_1086]);
if(((cljs.core.vector_QMARK_.call(null,val_1087)) && ((reagent.impl.template.key_from_vec.call(null,val_1087) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_1086] = reagent.impl.template.as_element.call(null,val_1087));

var G__1088 = (i_1086 + (1));
i_1086 = G__1088;
continue;
} else {
}
...
var ctx = ({});
var vec__1089 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__1089,(0),null);
var derefed = cljs.core.nth.call(null,vec__1089,(1),null);
...
var G__1092 = (cljs.core.count.call(null,argv) - first_child);
switch (G__1092) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__1092){
