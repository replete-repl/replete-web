<<<<<<< HEAD:docs/js/compiled/worker-out/re_frame/interop.js
// Compiled by ClojureScript 1.10.520 {:target :webworker}
=======
// Compiled by ClojureScript 1.10.520 {}
>>>>>>> :simple optimizations:docs/js/compiled/out/re_frame/interop.js
...
<<<<<<< HEAD:docs/js/compiled/worker-out/re_frame/interop.js
return [(function (){var pred__2108 = cljs.core.instance_QMARK_;
var expr__2109 = reactive_val;
if(cljs.core.truth_(pred__2108.call(null,reagent.ratom.RAtom,expr__2109))){
return "ra";
} else {
if(cljs.core.truth_(pred__2108.call(null,reagent.ratom.RCursor,expr__2109))){
return "rc";
} else {
if(cljs.core.truth_(pred__2108.call(null,reagent.ratom.Reaction,expr__2109))){
return "rx";
} else {
if(cljs.core.truth_(pred__2108.call(null,reagent.ratom.Track,expr__2109))){
=======
return [(function (){var pred__9252 = cljs.core.instance_QMARK_;
var expr__9253 = reactive_val;
if(cljs.core.truth_(pred__9252.call(null,reagent.ratom.RAtom,expr__9253))){
return "ra";
} else {
if(cljs.core.truth_(pred__9252.call(null,reagent.ratom.RCursor,expr__9253))){
return "rc";
} else {
if(cljs.core.truth_(pred__9252.call(null,reagent.ratom.Reaction,expr__9253))){
return "rx";
} else {
if(cljs.core.truth_(pred__9252.call(null,reagent.ratom.Track,expr__9253))){
>>>>>>> :simple optimizations:docs/js/compiled/out/re_frame/interop.js
return "tr";
} else {
return "other";
