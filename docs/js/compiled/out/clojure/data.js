...
return cljs.core.reduce.call(null,(function (result,p__11912){
...
var vec__11916 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__11916,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__11916,(1),null);
var ab = cljs.core.nth.call(null,vec__11916,(2),null);
...
return (function (){var G__11925 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11925__$1)].join('')));
