...
var digit_10241 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_10242__$1 = (vlq >>> (5));
while(true){
if((vlq_10242__$1 > (0))){
var digit_10243__$1 = (digit_10241 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_10243__$1));

var G__10244 = (vlq_10242__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__10245 = (vlq_10242__$1 >>> (5));
digit_10241 = G__10244;
vlq_10242__$1 = G__10245;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_10241));
}
break;
}
...
var G__10246 = i__$1;
var G__10247 = result__$1;
var G__10248 = shift__$1;
i = G__10246;
result = G__10247;
shift = G__10248;
continue;
