...
var line = cljs.core.get.call(null,map__12847__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__12847__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e12846){var _e = e12846;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___12849 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___12849)){
var seen_errors_12850 = temp__5718__auto___12849;
if(cljs.core.truth_(seen_errors_12850.has(self))){
} else {
seen_errors_12850.add(self);

var temp__5720__auto___12851 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___12851)){
var sense_12852 = temp__5720__auto___12851;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_12852)].join('');
} else {
}
}
} else {
