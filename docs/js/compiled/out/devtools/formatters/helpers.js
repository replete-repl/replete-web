...
var G__9726 = devtools.prefs.pref.call(null,v);
v = G__9726;
continue;
} else {
return v;
...
}catch (e9729){var _e__8738__auto__ = e9729;
return false;
}})();
...
}catch (e9733){var _e__8738__auto__ = e9733;
return false;
}})();
...
}catch (e9735){var _e__8738__auto__ = e9735;
return false;
}}
}
});
...
var vec__9737 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__9737,(0),null);
var name = cljs.core.nth.call(null,vec__9737,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__9740_SHARP_);
}),template);
});
