...
var len__4730__auto___9755 = arguments.length;
var i__4731__auto___9756 = (0);
while(true){
if((i__4731__auto___9756 < len__4730__auto___9755)){
args__4736__auto__.push((arguments[i__4731__auto___9756]));

var G__9757 = (i__4731__auto___9756 + (1));
i__4731__auto___9756 = G__9757;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq9752){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9753,G__9754,seq9752__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__9758_SHARP_){
return (!((cljs.core.meta.call(null,p1__9758_SHARP_) == null)));
})))){
...
var map__9759 = opts;
var map__9759__$1 = (((((!((map__9759 == null))))?(((((map__9759.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9759.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9759):map__9759);
var markup_db = cljs.core.get.call(null,map__9759__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e9763){var _e__8738__auto__ = e9763;
return false;
}})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
}catch (e9765){var _e__8738__auto__ = e9765;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__9767 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__9768 = devtools.formatters.state.get_current_state.call(null);
devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__9768;

try{var map__9769 = opts;
...
var markup_db = cljs.core.get.call(null,map__9769__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__9767;
}});
...
;
var temp__5718__auto___9774 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5718__auto___9774)){
var managed_print_level_9775 = temp__5718__auto___9774;
var _STAR_print_level_STAR__orig_val__9772_9776 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__9773_9777 = managed_print_level_9775;
cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__9773_9777;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR__orig_val__9772_9776,_STAR_print_level_STAR__temp_val__9773_9777,managed_print_level_9775,temp__5718__auto___9774,writer,opts,job_fn){
return (function (p1__9771_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__9771_SHARP_,null);
});})(_STAR_print_level_STAR__orig_val__9772_9776,_STAR_print_level_STAR__temp_val__9773_9777,managed_print_level_9775,temp__5718__auto___9774,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__9772_9776;
}} else {
job_fn.call(null);
}
