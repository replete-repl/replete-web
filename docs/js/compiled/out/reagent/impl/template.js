...
var G__10672 = o;
(G__10672[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__10676 = o;
(G__10676[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__10678__i < G__10678__a.length) {G__10678__a[G__10678__i] = arguments[G__10678__i + 0]; ++G__10678__i;}
  args = new cljs.core.IndexedSeq(G__10678__a,0,null);
} 
...
var G__10681 = props;
var G__10681__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10681,cljs.core.cst$kw$id,id):G__10681);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10681__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__10682){
var map__10683 = p__10682;
var map__10683__$1 = (((((!((map__10683 == null))))?(((((map__10683.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10683.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10683):map__10683);
var props = map__10683__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10683__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__10683,map__10683__$1,props,class$){
return (function (c){
...
});})(map__10683,map__10683__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10685){
var map__10686 = p__10685;
var map__10686__$1 = (((((!((map__10686 == null))))?(((((map__10686.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10686.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__10686):map__10686);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10686__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__10686,map__10686__$1,on_write){
return (function (){
...
});})(node_value,map__10686,map__10686__$1,on_write))
);
} else {
...
var G__10689 = jsprops;
(G__10689["defaultValue"] = value);

(G__10689["onChange"] = ((function (G__10689,v,value,on_change){
return (function (p1__10688_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__10688_SHARP_);
});})(G__10689,v,value,on_change))
);
...
var vec__10692 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10692,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10692,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10692,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___10696 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___10696 == null)){
} else {
var key_10697 = temp__5724__auto___10696;
(jsprops["key"] = key_10697);
}
...
var temp__5724__auto___10698 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___10698 == null)){
} else {
var key_10699 = temp__5724__auto___10698;
reagent.impl.template.oset(jsprops,"key",key_10699);
}
...
var G__10700 = reagent.impl.template.__GT_NativeWrapper();
(G__10700["name"] = c);
...
var G__10701 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__10701) : reagent.impl.template.as_element.call(null,G__10701));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10705){
var G__10706 = cljs.core.first(seq10705);
var seq10705__$1 = cljs.core.next(seq10705);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10706,seq10705__$1);
});
...
break;
default:
var G__10712 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__10712;
continue;
...
var n__4607__auto___10714 = a.length;
var i_10715 = (0);
while(true){
if((i_10715 < n__4607__auto___10714)){
(a[i_10715] = reagent.impl.template.as_element((a[i_10715])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___10717 = a.length;
var i_10718 = (0);
while(true){
if((i_10718 < n__4607__auto___10717)){
var val_10719 = (a[i_10718]);
if(((cljs.core.vector_QMARK_(val_10719)) && ((reagent.impl.template.key_from_vec(val_10719) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_10718] = reagent.impl.template.as_element(val_10719));
...
var ctx = ({});
var vec__10721 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10721,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10721,(1),null);
...
var G__10724 = (cljs.core.count(argv) - first_child);
switch (G__10724) {
case (0):
...
case (1):
var G__10725 = comp;
var G__10726 = jsprops;
var G__10727 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__10725,G__10726,G__10727) : reagent.impl.template.global$module$react.createElement.call(null,G__10725,G__10726,G__10727));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__10724){
