...
var G__7192 = o;
(G__7192[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__7196 = o;
(G__7196[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
var args = null;
if (arguments.length > 0) {
var G__7198__i = 0, G__7198__a = new Array(arguments.length -  0);
while (G__7198__i < G__7198__a.length) {G__7198__a[G__7198__i] = arguments[G__7198__i + 0]; ++G__7198__i;}
  args = new cljs.core.IndexedSeq(G__7198__a,0,null);
} 
...
var G__7201 = props;
var G__7201__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__7201,cljs.core.cst$kw$id,id):G__7201);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__7201__$1,cljs.core.cst$kw$class,(function (){var old_class = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__7202){
var map__7203 = p__7202;
...
var props = map__7203__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7203__$1,cljs.core.cst$kw$class);
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,cljs.core.cst$kw$class,clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__7203,map__7203__$1,props,class$){
return (function (c){
...
});})(map__7203,map__7203__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__7205){
var map__7206 = p__7205;
var map__7206__$1 = (((((!((map__7206 == null))))?(((((map__7206.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__7206.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__7206):map__7206);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7206__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__7206,map__7206__$1,on_write){
return (function (){
...
});})(node_value,map__7206,map__7206__$1,on_write))
);
} else {
...
var G__7209 = jsprops;
(G__7209["defaultValue"] = value);

(G__7209["onChange"] = ((function (G__7209,v,value,on_change){
return (function (p1__7208_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__7208_SHARP_);
});})(G__7209,v,value,on_change))
);
...
var vec__7212 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7212,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7212,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7212,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___7216 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___7216 == null)){
} else {
var key_7217 = temp__5724__auto___7216;
(jsprops["key"] = key_7217);
}
...
var temp__5724__auto___7218 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___7218 == null)){
} else {
var key_7219 = temp__5724__auto___7218;
reagent.impl.template.oset(jsprops,"key",key_7219);
}
...
var G__7220 = reagent.impl.template.__GT_NativeWrapper();
(G__7220["name"] = c);
...
var G__7221 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__7221) : reagent.impl.template.as_element.call(null,G__7221));
} else {
...
var len__4730__auto___7227 = arguments.length;
var i__4731__auto___7228 = (0);
while(true){
if((i__4731__auto___7228 < len__4730__auto___7227)){
args__4736__auto__.push((arguments[i__4731__auto___7228]));

var G__7229 = (i__4731__auto___7228 + (1));
i__4731__auto___7228 = G__7229;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq7225){
var G__7226 = cljs.core.first(seq7225);
var seq7225__$1 = cljs.core.next(seq7225);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__7226,seq7225__$1);
});
...
break;
default:
var G__7232 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__7232;
continue;
...
var n__4607__auto___7234 = a.length;
var i_7235 = (0);
while(true){
if((i_7235 < n__4607__auto___7234)){
(a[i_7235] = reagent.impl.template.as_element((a[i_7235])));

var G__7236 = (i_7235 + (1));
i_7235 = G__7236;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___7237 = a.length;
var i_7238 = (0);
while(true){
if((i_7238 < n__4607__auto___7237)){
var val_7239 = (a[i_7238]);
if(((cljs.core.vector_QMARK_(val_7239)) && ((reagent.impl.template.key_from_vec(val_7239) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_7238] = reagent.impl.template.as_element(val_7239));

var G__7240 = (i_7238 + (1));
i_7238 = G__7240;
continue;
} else {
}
...
var ctx = ({});
var vec__7241 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7241,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7241,(1),null);
...
var G__7244 = (cljs.core.count(argv) - first_child);
switch (G__7244) {
case (0):
...
var G__7245 = comp;
var G__7246 = jsprops;
var G__7247 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__7245,G__7246,G__7247) : reagent.impl.template.global$module$react.createElement.call(null,G__7245,G__7246,G__7247));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__7244){
