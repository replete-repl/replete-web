...
if((i < len)){
var k = (ks[i]);
var G__7053 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__7054 = (i + (1));
m = G__7053;
i = G__7054;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__7056 = c;
var G__7056__$1 = (((G__7056 == null))?null:G__7056.prototype);
if((G__7056__$1 == null)){
return null;
} else {
return (G__7056__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__7058 = c;
var G__7058__$1 = (((G__7058 == null))?null:G__7058.prototype);
if((G__7058__$1 == null)){
return null;
} else {
return (G__7058__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__7061__delegate = function (args){
return reagent.impl.component.as_element.call(null,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
var G__7061 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__7062__i = 0, G__7062__a = new Array(arguments.length -  0);
while (G__7062__i < G__7062__a.length) {G__7062__a[G__7062__i] = arguments[G__7062__i + 0]; ++G__7062__i;}
  args = new cljs.core.IndexedSeq(G__7062__a,0,null);
} 
return G__7061__delegate.call(this,args);};
G__7061.cljs$lang$maxFixedArity = 0;
G__7061.cljs$lang$applyTo = (function (arglist__7063){
var args = cljs.core.seq(arglist__7063);
return G__7061__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__7065 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__7066 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__7066;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__7065;
}});
...
var G__7067 = key;
var G__7067__$1 = (((G__7067 instanceof cljs.core.Keyword))?G__7067.fqn:null);
switch (G__7067__$1) {
...
return ((function (G__7067,G__7067__$1){
...
var c = this;
var G__7072_7074 = (c["cljsRatom"]);
if((G__7072_7074 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__7072_7074);
}
...
var renders_7076 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_7077 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_7076));
if((cljs.core.count.call(null,renders_7076) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_7076))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_7077)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_7077)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__7075 = name;
switch (G__7075) {
case "":
...
var G__7079 = o;
(G__7079[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__7080 = fiber;
var G__7080__$1 = (((G__7080 == null))?null:(G__7080["type"]));
if((G__7080__$1 == null)){
return null;
} else {
return (G__7080__$1["displayName"]);
}
})();
var parent = (function (){var G__7081 = fiber;
if((G__7081 == null)){
return null;
} else {
return (G__7081["return"]);
}
})();
var path = (function (){var G__7082 = parent;
var G__7082__$1 = (((G__7082 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__7082));
if((G__7082__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__7082__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__7084 = c;
if((G__7084 == null)){
return null;
} else {
return (G__7084["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__7085._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__7087 = c;
if((G__7087 == null)){
return null;
} else {
...
var or__4131__auto____$1 = (function (){var G__7089 = c;
if((G__7089 == null)){
return null;
} else {
return G__7089._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__7091 = instance;
if((G__7091 == null)){
return null;
} else {
return (G__7091["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__7092 = instance;
if((G__7092 == null)){
return null;
} else {
return G__7092._currentElement;
}
}
})();
var name = (function (){var G__7093 = elem;
var G__7093__$1 = (((G__7093 == null))?null:(G__7093["type"]));
if((G__7093__$1 == null)){
return null;
} else {
return (G__7093__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__7095 = elem;
if((G__7095 == null)){
return null;
} else {
return (G__7095["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__7096._owner;
}
}
})();
var path = (function (){var G__7097 = owner;
var G__7097__$1 = (((G__7097 == null))?null:reagent.impl.component.component_path.call(null,G__7097));
if((G__7097__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__7097__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__7098 = c;
var G__7098__$1 = (((G__7098 == null))?null:G__7098.constructor);
if((G__7098__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__7098__$1);
}
}
})();
