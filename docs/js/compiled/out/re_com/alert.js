...
re_com.alert.alert_box.cljs$core$IFn$_invoke$arity$variadic = (function (p__19211){
var map__19212 = p__19211;
var map__19212__$1 = (((((!((map__19212 == null))))?(((((map__19212.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19212.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__19212):map__19212);
var args = map__19212__$1;
var closeable_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19212__$1,cljs.core.cst$kw$closeable_QMARK_);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19212__$1,cljs.core.cst$kw$body);
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19212__$1,cljs.core.cst$kw$attr);
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19212__$1,cljs.core.cst$kw$heading);
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19212__$1,cljs.core.cst$kw$on_DASH_close);
var alert_type = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__19212__$1,cljs.core.cst$kw$alert_DASH_type,cljs.core.cst$kw$info);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19212__$1,cljs.core.cst$kw$style);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19212__$1,cljs.core.cst$kw$id);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19212__$1,cljs.core.cst$kw$class);
var padding = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19212__$1,cljs.core.cst$kw$padding);
...
var close_alert = new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.close_button.close_button,cljs.core.cst$kw$on_DASH_click,((function (map__19212,map__19212__$1,args,closeable_QMARK_,body,attr,heading,on_close,alert_type,style,id,class$,padding){
return (function (){
return (on_close.cljs$core$IFn$_invoke$arity$1 ? on_close.cljs$core$IFn$_invoke$arity$1(id) : on_close.call(null,id));
});})(map__19212,map__19212__$1,args,closeable_QMARK_,body,attr,heading,on_close,alert_type,style,id,class$,padding))
,cljs.core.cst$kw$div_DASH_size,(20),cljs.core.cst$kw$font_DASH_size,(20)], null);
var alert_class = (function (){var G__19214 = new cljs.core.PersistentArrayMap(null, 4, [cljs.core.cst$kw$none,"",cljs.core.cst$kw$info,"alert-success",cljs.core.cst$kw$warning,"alert-warning",cljs.core.cst$kw$danger,"alert-danger"], null);
return (alert_type.cljs$core$IFn$_invoke$arity$1 ? alert_type.cljs$core$IFn$_invoke$arity$1(G__19214) : alert_type.call(null,G__19214));
})();
...
/** @this {Function} */
re_com.alert.alert_box.cljs$lang$applyTo = (function (seq19210){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq19210));
});
...
re_com.alert.alert_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__19219){
...
var args = map__19220__$1;
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19220__$1,cljs.core.cst$kw$attr);
var border_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19220__$1,cljs.core.cst$kw$border_DASH_style);
var max_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19220__$1,cljs.core.cst$kw$max_DASH_height);
var on_close = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19220__$1,cljs.core.cst$kw$on_DASH_close);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19220__$1,cljs.core.cst$kw$style);
var alert_style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19220__$1,cljs.core.cst$kw$alert_DASH_style);
var alert_class = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19220__$1,cljs.core.cst$kw$alert_DASH_class);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19220__$1,cljs.core.cst$kw$class);
var alerts = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19220__$1,cljs.core.cst$kw$alerts);
var padding = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__19220__$1,cljs.core.cst$kw$padding,"4px");
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.box,cljs.core.cst$kw$child,new cljs.core.PersistentVector(null, 13, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.border,cljs.core.cst$kw$class,["rc-alert-list ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(class$)].join(''),cljs.core.cst$kw$style,style,cljs.core.cst$kw$attr,attr,cljs.core.cst$kw$padding,padding,cljs.core.cst$kw$border,border_style,cljs.core.cst$kw$child,new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.scroller,cljs.core.cst$kw$v_DASH_scroll,cljs.core.cst$kw$auto,cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$max_DASH_height,max_height], null),cljs.core.cst$kw$child,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.box.v_box,cljs.core.cst$kw$size,"auto",cljs.core.cst$kw$children,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var iter__4523__auto__ = ((function (alerts__$1,map__19220,map__19220__$1,args,attr,border_style,max_height,on_close,style,alert_style,alert_class,class$,alerts,padding){
return (function re_com$alert$iter__19222(s__19223){
return (new cljs.core.LazySeq(null,((function (alerts__$1,map__19220,map__19220__$1,args,attr,border_style,max_height,on_close,style,alert_style,alert_class,class$,alerts,padding){
return (function (){
var s__19223__$1 = s__19223;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__19223__$1);
if(temp__5720__auto__){
var s__19223__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__19223__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__19223__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__19225 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__19224 = (0);
while(true){
if((i__19224 < size__4522__auto__)){
var alert = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__19224);
cljs.core.chunk_append(b__19225,(function (){var map__19226 = alert;
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19226__$1,cljs.core.cst$kw$id);
var alert_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19226__$1,cljs.core.cst$kw$alert_DASH_type);
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19226__$1,cljs.core.cst$kw$heading);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19226__$1,cljs.core.cst$kw$body);
var padding__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19226__$1,cljs.core.cst$kw$padding);
var closeable_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19226__$1,cljs.core.cst$kw$closeable_QMARK_);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__19225),re_com$alert$iter__19222(cljs.core.chunk_rest(s__19223__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__19225),null);
}
} else {
var alert = cljs.core.first(s__19223__$2);
return cljs.core.cons((function (){var map__19228 = alert;
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19228__$1,cljs.core.cst$kw$id);
var alert_type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19228__$1,cljs.core.cst$kw$alert_DASH_type);
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19228__$1,cljs.core.cst$kw$heading);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19228__$1,cljs.core.cst$kw$body);
var padding__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19228__$1,cljs.core.cst$kw$padding);
var closeable_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19228__$1,cljs.core.cst$kw$closeable_QMARK_);
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 19, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.alert.alert_box,cljs.core.cst$kw$id,id,cljs.core.cst$kw$alert_DASH_type,alert_type,cljs.core.cst$kw$heading,heading,cljs.core.cst$kw$body,body,cljs.core.cst$kw$padding,padding__$1,cljs.core.cst$kw$closeable_QMARK_,closeable_QMARK_,cljs.core.cst$kw$on_DASH_close,on_close,cljs.core.cst$kw$class,alert_class,cljs.core.cst$kw$style,alert_style], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,id], null));
})(),re_com$alert$iter__19222(cljs.core.rest(s__19223__$2)));
}
} else {
return null;
}
...
});})(alerts__$1,map__19220,map__19220__$1,args,attr,border_style,max_height,on_close,style,alert_style,alert_class,class$,alerts,padding))
,null,null));
});})(alerts__$1,map__19220,map__19220__$1,args,attr,border_style,max_height,on_close,style,alert_style,alert_class,class$,alerts,padding))
;
...
/** @this {Function} */
re_com.alert.alert_list.cljs$lang$applyTo = (function (seq19218){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq19218));
});
