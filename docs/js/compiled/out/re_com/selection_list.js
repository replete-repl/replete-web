...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__19141){
...
var args = map__19142__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__19142__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__19142__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var height = cljs.core.get.call(null,map__19142__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var item_renderer = cljs.core.get.call(null,map__19142__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__19142__$1,new cljs.core.Keyword(null,"model","model",331153215));
var attr = cljs.core.get.call(null,map__19142__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var label_fn = cljs.core.get.call(null,map__19142__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__19142__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__19142__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var max_height = cljs.core.get.call(null,map__19142__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var hide_border_QMARK_ = cljs.core.get.call(null,map__19142__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var width = cljs.core.get.call(null,map__19142__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var choices = cljs.core.get.call(null,map__19142__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__19142__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var style = cljs.core.get.call(null,map__19142__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var class$ = cljs.core.get.call(null,map__19142__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var multi_select_QMARK_ = cljs.core.get.call(null,map__19142__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__19142,map__19142__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_){
return (function (p1__19138_SHARP_){
return item_renderer.call(null,p1__19138_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__19142,map__19142__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__19142,map__19142__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_){
return (function (p1__19139_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__19139_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__19142,map__19142__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_))
:((function (selected,map__19142,map__19142__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_){
return (function (p1__19140_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__19140_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__19142,map__19142__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_))
)),choices);
...
var len__4730__auto___19151 = arguments.length;
var i__4731__auto___19152 = (0);
while(true){
if((i__4731__auto___19152 < len__4730__auto___19151)){
args__4736__auto__.push((arguments[i__4731__auto___19152]));

var G__19153 = (i__4731__auto___19152 + (1));
i__4731__auto___19152 = G__19153;
continue;
} else {
}
break;
...
re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__19145){
...
var args = map__19146__$1;
if((((!(goog.DEBUG)))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list"))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__19146,map__19146__$1,args){
return (function() { 
var G__19154__delegate = function (p__19148){
...
while (G__19155__i < G__19155__a.length) {G__19155__a[G__19155__i] = arguments[G__19155__i + 0]; ++G__19155__i;}
  p__19148 = new cljs.core.IndexedSeq(G__19155__a,0,null);
} 
return G__19154__delegate.call(this,p__19148);};
G__19154.cljs$lang$maxFixedArity = 0;
G__19154.cljs$lang$applyTo = (function (arglist__19156){
var p__19148 = cljs.core.seq(arglist__19156);
return G__19154__delegate(p__19148);
});
G__19154.cljs$core$IFn$_invoke$arity$variadic = G__19154__delegate;
return G__19154;
})()
;
;})(map__19146,map__19146__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

/** @this {Function} */
re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq19144){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq19144));
});
