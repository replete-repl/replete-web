...
var G__19952_19953 = re_com.selection_list.check_clicked(selections,item_id,cljs.core.not((selections.cljs$core$IFn$_invoke$arity$1 ? selections.cljs$core$IFn$_invoke$arity$1(item_id) : selections.call(null,item_id))),required_QMARK_);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__19952_19953) : on_change.call(null,G__19952_19953));
}
...
var G__19954_19955 = re_com.selection_list.radio_clicked(selections,item_id,required_QMARK_);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__19954_19955) : on_change.call(null,G__19954_19955));
}
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__19959){
...
var args = map__19960__$1;
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19960__$1,cljs.core.cst$kw$disabled_QMARK_);
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19960__$1,cljs.core.cst$kw$on_DASH_change);
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19960__$1,cljs.core.cst$kw$height);
var item_renderer = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19960__$1,cljs.core.cst$kw$item_DASH_renderer);
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19960__$1,cljs.core.cst$kw$model);
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19960__$1,cljs.core.cst$kw$attr);
var label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19960__$1,cljs.core.cst$kw$label_DASH_fn);
var required_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19960__$1,cljs.core.cst$kw$required_QMARK_);
var as_exclusions_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19960__$1,cljs.core.cst$kw$as_DASH_exclusions_QMARK_);
var max_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19960__$1,cljs.core.cst$kw$max_DASH_height);
var hide_border_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19960__$1,cljs.core.cst$kw$hide_DASH_border_QMARK_);
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19960__$1,cljs.core.cst$kw$width);
var choices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19960__$1,cljs.core.cst$kw$choices);
var id_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19960__$1,cljs.core.cst$kw$id_DASH_fn);
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19960__$1,cljs.core.cst$kw$style);
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19960__$1,cljs.core.cst$kw$class);
var multi_select_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__19960__$1,cljs.core.cst$kw$multi_DASH_select_QMARK_);
...
var items = cljs.core.map.cljs$core$IFn$_invoke$arity$2((cljs.core.truth_(item_renderer)?((function (selected,map__19960,map__19960__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_){
return (function (p1__19956_SHARP_){
return (item_renderer.cljs$core$IFn$_invoke$arity$8 ? item_renderer.cljs$core$IFn$_invoke$arity$8(p1__19956_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_) : item_renderer.call(null,p1__19956_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_));
});})(selected,map__19960,map__19960__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__19960,map__19960__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_){
return (function (p1__19957_SHARP_){
return re_com.selection_list.as_checked(p1__19957_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__19960,map__19960__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_))
:((function (selected,map__19960,map__19960__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_){
return (function (p1__19958_SHARP_){
return re_com.selection_list.as_radio(p1__19958_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__19960,map__19960__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,attr,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,style,class$,multi_select_QMARK_))
)),choices);
...
var len__4730__auto___19969 = arguments.length;
var i__4731__auto___19970 = (0);
while(true){
if((i__4731__auto___19970 < len__4730__auto___19969)){
args__4736__auto__.push((arguments[i__4731__auto___19970]));

var G__19971 = (i__4731__auto___19970 + (1));
i__4731__auto___19970 = G__19971;
continue;
} else {
}
break;
...
re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__19963){
...
var args = map__19964__$1;
if((((!(goog.DEBUG)))?true:re_com.validate.validate_args.cljs$core$IFn$_invoke$arity$variadic(re_com.validate.extract_arg_data(re_com.selection_list.selection_list_args_desc),args,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["selection-list"], 0)))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__19964,map__19964__$1,args){
return (function() { 
var G__19972__delegate = function (p__19966){
var map__19967 = p__19966;
var map__19967__$1 = (((((!((map__19967 == null))))?(((((map__19967.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__19967.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__19967):map__19967);
var args__$1 = map__19967__$1;
...
var G__19972 = function (var_args){
var p__19966 = null;
if (arguments.length > 0) {
var G__19973__i = 0, G__19973__a = new Array(arguments.length -  0);
while (G__19973__i < G__19973__a.length) {G__19973__a[G__19973__i] = arguments[G__19973__i + 0]; ++G__19973__i;}
  p__19966 = new cljs.core.IndexedSeq(G__19973__a,0,null);
} 
return G__19972__delegate.call(this,p__19966);};
G__19972.cljs$lang$maxFixedArity = 0;
G__19972.cljs$lang$applyTo = (function (arglist__19974){
var p__19966 = cljs.core.seq(arglist__19974);
return G__19972__delegate(p__19966);
});
G__19972.cljs$core$IFn$_invoke$arity$variadic = G__19972__delegate;
return G__19972;
})()
;
;})(map__19964,map__19964__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

/** @this {Function} */
re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq19962){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq19962));
});
